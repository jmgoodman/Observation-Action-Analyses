function copyaxes(source, destination, varargin) % doesn't work because MATLAB figure properties are a mysterious web of buggy nonsense
% 
...
% https://de.mathworks.com/matlabcentral/fileexchange/34314-copyaxes

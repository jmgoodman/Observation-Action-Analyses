...
elseif ndims(data) == 4 && size(data,3)==2
    ...
    % COLOR SELECTION
    %     colors = distinguishable_colors(numOfStimuli); % these colors are ugly
    colors = flipud(copper(numOfStimuli)); % these follow a gradient. nice for when you're showing a subset of SORTED objects (i.e., best, median, worst, as assessed on a PER NEURON BASIS)

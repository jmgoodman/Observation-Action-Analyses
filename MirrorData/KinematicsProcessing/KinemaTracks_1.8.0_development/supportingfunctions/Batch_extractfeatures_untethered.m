...
% Updates function to "un-tether" feature extraction from the GUI
% (note: as of 2020 Jan 15 no edits have actually been made, apart from
% storing kinematics in global variables rather than saving the output of
% this function)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if extractoption.trialplot; plottrials(TO); end;

tc=[];

if ~extractoption.notrialinfo
    % load cut out times:
    tc = getcutouts(extractoption.subject,extractoption.session);
end

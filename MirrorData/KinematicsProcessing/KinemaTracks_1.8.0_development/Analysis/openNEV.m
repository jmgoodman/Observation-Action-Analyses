function [DigitalIO Spikes] = openNEV(varargin)
...
if fname==0; clear variables;; return; end;
tic;
...
DigitalIO.Data=NEV.Data.SerialDigitalIO.UnparsedData;
DigitalIO.TimeStamp=NEV.Data.SerialDigitalIO.TimeStamp;
DigitalIO.TimeStampSec=NEV.Data.SerialDigitalIO.TimeStampSec;

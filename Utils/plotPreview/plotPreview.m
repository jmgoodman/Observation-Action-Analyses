...
% TODO: figure out how to get ACCURATE scaling of text w.r.t. page size in
% the preview. It's a fine enough tool as-is to change, in real-time, the
% text size w.r.t. the visual assets, but realistically I'd like the
% parameters to have some foundation in reality!
global axes2Copy

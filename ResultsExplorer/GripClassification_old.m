function varargout = GripClassification_old(varargin)
...
% Last Modified by GUIDE v2.5 15-Jun-2022 10:46:22
...
% --- Executes on selection change in trainPoolOverride.
function trainPoolOverride_Callback(hObject, eventdata, handles)
% hObject    handle to trainPoolOverride (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns trainPoolOverride contents as cell array
%        contents{get(hObject,'Value')} returns selected item from trainPoolOverride
updatePeakAccuracy(hObject, eventdata, handles);


% --- Executes during object creation, after setting all properties.
function trainPoolOverride_CreateFcn(hObject, eventdata, handles)
% hObject    handle to trainPoolOverride (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in testPoolOverride.
function testPoolOverride_Callback(hObject, eventdata, handles)
% hObject    handle to testPoolOverride (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns testPoolOverride contents as cell array
%        contents{get(hObject,'Value')} returns selected item from testPoolOverride
updatePeakAccuracy(hObject, eventdata, handles);


% --- Executes during object creation, after setting all properties.
function testPoolOverride_CreateFcn(hObject, eventdata, handles)
% hObject    handle to testPoolOverride (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
